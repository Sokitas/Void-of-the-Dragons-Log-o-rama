...
class CombatAnalyzer:
    ...
    def display_results(self):
        ...
        regular_hit_damage = max(0, overall_damage - sum(
            effect['total_damage'] for effect in self.player_effects.values()))
...
class CombatLogParserApp:
    def __init__(self, root):
        self.root = root
        root.title("Sokitas' Void of the Dragons Log-o-rama 2.0 - Electric Log-aloo 2: Log Harder")
